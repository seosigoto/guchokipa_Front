...
const RunningGames = (props) => {
  ...
  const renderOpenGames = (game) => {
    const userIsPlayer1 = userIsCurrentPlayer(account?.address, game.player);
    const userIsPlayer2 = userIsCurrentPlayer(account?.address, game.owner);
    const playerCanReveal = userIsPlayer2 && userIsPlayer1;
    ...
    return (
      <>
        ...
        <Grid container sx={styles.Grid}>
          ...
          <button onClick={() => joinGame(game.tokenId)}>Join</button>
        </Grid>
